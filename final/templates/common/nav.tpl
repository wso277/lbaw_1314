        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="{$BASE_URL}pages/users/profile.php?username={$USERNAME}#friends"><span
                                    class="glyphicon glyphicon-list"/>&nbsp;Friends</a></li>
                    <li><a href="{$BASE_URL}pages/content/publish.php"><i class="glyphicon glyphicon-share"></i>&nbsp;Share
                            It!</a>
                        {else}
                    <li><a href="{$BASE_URL}pages/users/login.php"><span class="glyphicon glyphicon-user"/>&nbsp;Profile</a>
                    </li>
                    <li><a href="{$BASE_URL}pages/users/login.php"><span class="glyphicon glyphicon-list"/>&nbsp;Friends</a>
                    </li>
                    <li><a href="{$BASE_URL}pages/users/login.php"><i class="glyphicon glyphicon-share"></i>&nbsp;Share
                            It!</a>
                        {/if}
                ...
                <ul class="nav navbar-nav navbar-right">
                    ...
                    {if ($USERNAME != "")}
                        <li><a href="" data-toggle="modal" data-target="#what" data-original-title><i
                                        class="glyphicon glyphicon-question-sign"></i>&nbsp;What am I doing here?</a>
                        </li>
    ...
    <div class="modal-dialog">
        <div class="panel panel-primary" style="border-color:#428bca">
            <div class="panel-heading" style="background-color:#428bca;border-color:#428bca">
                ...
                <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-question-sign"></span>What am
                    I doing here?</h4>
            </div>
            <div class="modal-body" style="padding: 5px;">
                ...
                {else}
                    <p>As a <b>Visitor</b>, you can see all our content, who posted it and share news via Facebook.
                        Plus, you can <span class="glyphicon glyphicon-check"></span><b>Register</b> to our great
                        website!</p>
                    <p>If you are already a member, please <span class="glyphicon glyphicon-log-in"></span><b> Log
                            In</b>. From this page you can go to your <span class="glyphicon glyphicon-user"></span><b>Profile</b>,
