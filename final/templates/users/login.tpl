    ...
    <div class="row">
        <div class="col-sm-6 col-md-4 col-md-offset-4">
            ...
            <div class="account-wall">
                <img class="profile-img" src="{$BASE_URL}images/assets/default.png" alt="user" align="middle">
                ...
                <form action="{$BASE_URL}actions/users/login.php" class="form-signin" method="post"
                    ...
                    <a class="pull-left need-help" href="" data-toggle="modal" data-target="#forgot"
                       data-original-title>Forgot your password?</a>
        ...
        <div class="modal-dialog">
            <div class="panel panel-primary" style="border-color:#428bca">
                <div class="panel-heading" style="background-color:#428bca;border-color:#428bca">
                    ...
                    <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-question-sign"></span>Help
                    </h4>
                </div>
        ...
        <div class="modal-dialog">
            <div class="panel panel-primary" style="border-color:#428bca">
                <div class="panel-heading" style="background-color:#428bca;border-color:#428bca">
                    ...
                    <h4 class="panel-title" id="contactLabel"><span class="glyphicon glyphicon-question-sign"></span>Forgot
                        your password?</h4>
                </div>
                <div class="modal-body" style="padding: 5px;">
