...
<div class="container ">
    <div>
        ...
        <div class="col-sm-8 contact-form" style="float:left;clear:left">
            <form id="public" method="post" class="form" role="form">
                <div class="row">
                ...
                <textarea class="form-control" style="resize:vertical" id="message" name="message" placeholder="Message"
                          rows="10"></textarea>
                <br/>
    ...
    <div class="link-form">
        ...
        <div class="control-group" id="fields">
            <label class="control-label" for="field1">Included links</label>

            <div class="controls" id="profs">
                <div class="input-append">
                    <input autocomplete="off" class="span3 link-box" id="field1" name="prof1" type="text"
                ...
                <div id="small">
                    <small>Press + to add another link</small>
                </div>
