...
Update Editor SET email='olaeusouox@olaeusouox.fe.up.pt' WHERE username LIKE 'filetez';
...
Update Editor SET pass='sosegurashuchamaze' WHERE username LIKE 'filetez';

//Apagar noticia -> TRIGGER para apagar comentarios etc, tudo que referencia este id
DELETE FROM Noticia WHERE idNoticia = 1 CASCADE;

//Apagar comentario a mesma merda